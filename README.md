...
- **Jardin secret v1 (24/09/2026)** : layout agrandi **816×1152** (≈ 2×2,8 la référence) avec les **textures canoniques de `secretgarden.png`** — chaque pixel copié de la référence (synthèse guidée par patchs, provenance pixel par pixel), clairière sacrée/rayon reposés à l'identique, couloir sinueux, 4 alcôves, **feuillage immersif d'avant-plan** ; 8 calques 8 px jour + nuit Abyss, ORA → `renders/jardin_secret_v1/README.md`, [galerie](apercu_jardin_secret_v1.html). PMDO non testé.
- **Jardin secret v2 (24/09/2026)** : méthode spriter (générateur **fond magenta**, un calque par appel, détourage, échelle canonique, assemblage multicalque, corrections aux outils) — **chemin droit**, feuillage immersif festonné, **arbres à la taille Halcyon** (cime 126 px), **fleurs animées sur leurs propres calques** (3 horloges × 3 poses 24×24), **hokora miniature de Celebi** sur la souche ; jour + nuit Abyss → `renders/jardin_secret_v2/README.md`, [galerie animée](apercu_jardin_secret_v2.html). Pixels générés (sauf le rayon natif), PMDO non testé.
