...
Deux Friend Areas canoniques de l'Équipe de Secours Rouge GBA adaptées en maps PMDO 0.8.12 complètes : 5 calques sémantiques 8 px, sol 100% continu et opaque sous le décor, palettes 5-bit GBA multiples de 8 préservées (91 et 93 couleurs), filtre nocturne Abyss exact, rassemblement sud praticable (érosion 17 px), Ground `.rsground` et banques `.tile` 8 px validés en relecture exacte. Code et tests : `source/friend_areas_pmd_v1/work.py`.
