# Cap des Alizés — texture Treasure Town

**Nouveau layout**, 504 × 384 px, en jour et nuit. Cap en arc depuis le sud-ouest, chemin vers un belvédère à l’est.

[Ouvrir la zone](../../apercu_falaise.html) · [GIF jour/nuit](../../previews/littoral_jour_nuit.gif) · [Documentation des calques et du cycling](../README.md)

![Aperçu animé](../../previews/littoral_jour_nuit.gif)
...
Sources : `source/zones_treasure_town/littoral/`. La préparation et l’animation sont réalisées par le pipeline du dépôt, pas par un déplacement d’une capture complète. Aucune collision ni transition PMDO n’est configurée.
