...
Chaque image part d'une **case officielle de Dedenne lui-même** (Idle, Hurt, Hop, Charge, Rotate,
...
| Geste | Amplitude |
| --- | --- |
| plongée du repas | 2 px |
| respiration, hochement | 1 px |
| affaissement assis | 4 px |
