# Dedenne #0702 (Dedenne) — animations de scène ajoutées

![Aperçu](apercu.png)

Le sprite officiel de Dedenne sur [PMDCollab](https://sprites.pmdcollab.org/#/0702?form=0) a le set de donjon, mais
...
1. Chaque image d'une animation ajoutée est une **case officielle de Dedenne lui-même** (Idle, Hurt, Hop,
   ...
   la palette des nouvelles feuilles est incluse dans celle du sprite d'origine (14 couleurs).
...
| Fichier | Contenu |
| --- | --- |
| `AnimData.xml` | Sprite complet : animations d'origine **+** les 22 ajoutées, avec `ShadowSize` 0, cases, durées et créneaux. |
...
| `dedenne_scenes.aseprite` | Aseprite animé : un calque par direction, les 22 animations bout à bout, une étiquette chacune. |
...
| --- | --- | --- | --- | --- | --- | --- |
| `EventSleep` | 13 | 24 × 32 | 2 | 8 | 65 ticks | Sleep |
| `Wake` | 14 | 24 × 32 | 5 | 8 | 42 ticks | Idle, Sleep |
| `Eat` | 15 | 24 × 32 | 4 | 1 | 28 ticks | Idle |
| `Tumble` | 16 | 24 × 32 | 8 | 1 | 24 ticks | Rotate |
| `Pose` | 17 | 32 × 32 | 3 | 8 | 22 ticks | Charge, Idle |
| `Pull` | 18 | 24 × 32 | 7 | 1 | 76 ticks | Charge |
| `Pain` | 19 | 40 × 56 | 12 | 8 | 24 ticks | Hurt |
| `Float` | 20 | 24 × 48 | 4 | 8 | 50 ticks | Idle |
| `DeepBreath` | 21 | 24 × 32 | 9 | 1 | 62 ticks | Charge, Idle |
| `Nod` | 22 | 24 × 32 | 3 | 8 | 20 ticks | Idle |
| `Sit` | 23 | 24 × 32 | 3 | 1 | 24 ticks | Idle |
| `LookUp` | 24 | 24 × 40 | 3 | 1 | 18 ticks | Idle |
| `Sink` | 25 | 24 × 64 | 12 | 1 | 72 ticks | Idle |
| `Trip` | 26 | 32 × 56 | 5 | 8 | 22 ticks | Hurt |
| `Laying` | 27 | 16 × 32 | 1 | 8 | 12 ticks | Sleep |
| `LeapForth` | 28 | 24 × 104 | 6 | 1 | 14 ticks | Hop |
| `Head` | 29 | 32 × 32 | 1 | 8 | 4 ticks | Charge |
| `Cringe` | 30 | 32 × 56 | 2 | 1 | 10 ticks | Hurt |
| `LostBalance` | 31 | 32 × 48 | 2 | 1 | 16 ticks | Hurt |
| `TumbleBack` | 32 | 24 × 32 | 10 | 1 | 30 ticks | Rotate |
| `HitGround` | 34 | 32 × 48 | 8 | 1 | 34 ticks | Hurt |
| `Faint` | 33 | 40 × 48 | 4 | 8 | 34 ticks | Hurt |

Animations d'origine conservées telles quelles : `Walk`, `Attack`, `QuickStrike`, `Sleep`, `Hurt`, `Idle`, `Swing`, `Double`, `Hop`, `Charge`, `Rotate`.
...
Ce Pokémon a déjà **toutes ses émotions** publiées sur PMDCollab : rien à compléter côté portraits.
