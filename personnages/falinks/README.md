...
| --- | --- | --- | --- | --- | --- |
| Walk | 0 | 64 × 64 | 6 | 28 ticks | pas en vague, une image de retard par rang |
| Attack | 1 | 104 × 112 | 10 | 19 ticks | charge à l'unisson, Rush 1 · Hit 3 · Return 6 |
| Strike | 2 | — | — | — | copie d'Attack |
| Shoot | 3 | 64 × 80 | 13 | 29 ticks | cadence du trooper (élan, tir, recul) ; le brass fixe la cible, Hit 3 · Return 7 |
| Sleep | 5 | 56 × 40 | 2 | 65 ticks | bivouac sur deux rangs de trois, brass au centre du premier rang |
| Hurt | 6 | 72 × 72 | 2 | 10 ticks | toute l'escouade encaisse, étincelles d'impact sur le brass seulement |
| Idle | 7 | 64 × 80 | 13 | 60 ticks | garde-à-vous 40 ticks puis petit bond du brass repris de rang en rang |
| Swing | 8 | 104 × 112 | 9 | 16 ticks | à l'unisson, Hit 5 · Return 5 |
| Double | 9 | 88 × 72 | 16 | 36 ticks | à l'unisson (dédoublement latéral) |
| Hop | 10 | 64 × 112 | 10 | 24 ticks | à l'unisson, Hit 9 |
| Charge | 11 | 64 × 64 | 10 | 20 ticks | à l'unisson (tremblement), Hit 5 · Return 9 |
| Rotate | 12 | 64 × 64 | 9 | 18 ticks | à l'unisson (tour complet), Hit 8 |
...
Aucun pixel n'est repeint : les 13 couleurs sont celles des unités d'origine. C'est le travail d'un spriter
...
- **Sprite large.** Walk fait 64 × 64 px et Attack 104 × 112 px : l'escouade déborde d'une case de 24 px, comme
