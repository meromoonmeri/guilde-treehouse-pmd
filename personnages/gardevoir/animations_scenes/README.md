...
1. Chaque image d'une animation ajoutée est une **case officielle de Gardevoir lui-même** (Idle, Hurt, Hop,
   ...
   la palette des nouvelles feuilles est incluse dans celle du sprite d'origine (10 couleurs).
