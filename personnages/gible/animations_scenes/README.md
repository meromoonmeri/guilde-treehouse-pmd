# Gible #0443 (Griknot) — animations de scène ajoutées

![Aperçu](apercu.png)

Le sprite officiel de Gible sur [PMDCollab](https://sprites.pmdcollab.org/#/0443?form=0) a le set de donjon, mais
...
Chaque image part d'une **case officielle de Gible lui-même** (Idle, Hurt, Hop, Charge, Rotate,
...
`-Offsets.png` marque `head`, `lhand` et `rhand` sur chaque case. Pour Gible, les repères
...
donc calculées sur la hauteur réelle de la silhouette au repos de **Gible** (23 px) :
...
| `gible_scenes.aseprite` | Aseprite animé : un calque par direction, les 22 animations bout à bout, une étiquette chacune. |
...
| --- | --- | --- | --- | --- | --- | --- |
| `EventSleep` | 13 | 24 × 40 | 2 | 8 | 65 ticks | Sleep |
...
| `Pain` | 19 | 32 × 56 | 12 | 8 | 24 ticks | Hurt |
...
| `LeapForth` | 28 | 24 × 120 | 6 | 1 | 14 ticks | Hop |
| `Head` | 29 | 24 × 48 | 1 | 8 | 4 ticks | Charge |
| `Cringe` | 30 | 32 × 56 | 2 | 1 | 10 ticks | Hurt |
| `LostBalance` | 31 | 32 × 56 | 2 | 1 | 16 ticks | Hurt |
| `TumbleBack` | 32 | 24 × 48 | 10 | 1 | 30 ticks | Rotate |
| `HitGround` | 34 | 32 × 48 | 8 | 1 | 34 ticks | Hurt |
| `Faint` | 33 | 40 × 48 | 4 | 8 | 34 ticks | Hurt |

Animations d'origine conservées telles quelles : `Walk`, `Attack`, `Strike (copie de Attack)`, `Shoot`, `SpAttack (copie de RearUp)`, `RearUp`, `Sleep`, `Hurt`, `Idle`, `Swing`, `Double`, `Hop`, `Charge`, `Rotate`.
