# Hariyama #0297 (Hariyama) — animations de scène ajoutées

![Aperçu](apercu.png)

Le sprite officiel de Hariyama sur [PMDCollab](https://sprites.pmdcollab.org/#/0297?form=0) a le set de donjon, mais
...
Chaque image part d'une **case officielle de Hariyama lui-même** (Idle, Hurt, Hop, Charge, Rotate,
...
`-Offsets.png` marque `head`, `lhand` et `rhand` sur chaque case. Pour Hariyama, les repères
...
donc calculées sur la hauteur réelle de la silhouette au repos de **Hariyama** (29 px) :
...
| Fichier | Contenu |
| --- | --- |
| `AnimData.xml` | Sprite complet : animations d'origine **+** les 22 ajoutées, avec `ShadowSize` 2, cases, durées et créneaux. |
...
| `hariyama_scenes.aseprite` | Aseprite animé : un calque par direction, les 22 animations bout à bout, une étiquette chacune. |
...
| `Wake` | 14 | 40 × 56 | 5 | 8 | 42 ticks | Idle, Sleep |
| `Eat` | 15 | 32 × 56 | 4 | 1 | 28 ticks | Idle |
| `Tumble` | 16 | 40 × 56 | 8 | 1 | 24 ticks | Rotate |
| `Pose` | 17 | 40 × 56 | 3 | 8 | 22 ticks | Charge, Idle |
| `Pull` | 18 | 40 × 48 | 7 | 1 | 76 ticks | Charge |
| `Pain` | 19 | 40 × 56 | 12 | 8 | 24 ticks | Hurt |
| `Float` | 20 | 40 × 64 | 4 | 8 | 50 ticks | Idle |
| `DeepBreath` | 21 | 40 × 56 | 9 | 1 | 62 ticks | Charge, Idle |
| `Nod` | 22 | 40 × 56 | 3 | 8 | 20 ticks | Idle |
| `Sit` | 23 | 32 × 48 | 3 | 1 | 24 ticks | Idle |
| `LookUp` | 24 | 32 × 56 | 3 | 1 | 18 ticks | Idle |
| `Sink` | 25 | 32 × 56 | 12 | 1 | 72 ticks | Idle |
| `Trip` | 26 | 40 × 56 | 5 | 8 | 22 ticks | Hurt |
| `Laying` | 27 | 32 × 48 | 1 | 8 | 12 ticks | Sleep |
| `LeapForth` | 28 | 40 × 120 | 6 | 1 | 14 ticks | Hop |
| `Head` | 29 | 32 × 48 | 1 | 8 | 4 ticks | Charge |
| `Cringe` | 30 | 40 × 64 | 2 | 1 | 10 ticks | Hurt |
| `LostBalance` | 31 | 40 × 56 | 2 | 1 | 16 ticks | Hurt |
| `TumbleBack` | 32 | 40 × 56 | 10 | 1 | 30 ticks | Rotate |
| `HitGround` | 34 | 40 × 48 | 8 | 1 | 34 ticks | Hurt |
| `Faint` | 33 | 48 × 56 | 4 | 8 | 34 ticks | Hurt |

Animations d'origine conservées telles quelles : `Walk`, `Attack`, `Strike`, `Shoot`, `Twirl (copie de Rotate)`, `Sleep`, `Hurt`, `Idle`, `Swing`, `Double`, `Hop`, `Charge`, `Rotate`.
