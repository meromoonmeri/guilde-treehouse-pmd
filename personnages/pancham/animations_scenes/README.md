# Pancham #0674 (Pandespiègle) — animations de scène ajoutées

![Aperçu](apercu.png)

Le sprite officiel de Pancham sur [PMDCollab](https://sprites.pmdcollab.org/#/0674?form=0) a le set de donjon, mais
...
Chaque image part d'une **case officielle de Pancham lui-même** (Idle, Hurt, Hop, Charge, Rotate,
Sleep…). La palette des nouvelles feuilles est incluse dans celle du sprite d'origine
(13 couleurs) — le vérificateur le refuse sinon.
...
`-Offsets.png` marque `head`, `lhand` et `rhand` sur chaque case. Pour Pancham, les repères
...
donc calculées sur la hauteur réelle de la silhouette au repos de **Pancham** (23 px) :
...
| `pancham_scenes.aseprite` | Aseprite animé : un calque par direction, les 22 animations bout à bout, une étiquette chacune. |
...
| --- | --- | --- | --- | --- | --- | --- |
| `EventSleep` | 13 | 24 × 48 | 2 | 8 | 65 ticks | Sleep |
| `Wake` | 14 | 24 × 48 | 5 | 8 | 42 ticks | Idle, Sleep |
| `Eat` | 15 | 24 × 48 | 4 | 1 | 28 ticks | Idle |
| `Tumble` | 16 | 24 × 48 | 8 | 1 | 24 ticks | Rotate |
| `Pose` | 17 | 24 × 48 | 3 | 8 | 22 ticks | Charge, Idle |
| `Pull` | 18 | 24 × 48 | 7 | 1 | 76 ticks | Charge |
| `Pain` | 19 | 40 × 56 | 12 | 8 | 24 ticks | Hurt |
| `Float` | 20 | 24 × 56 | 4 | 8 | 50 ticks | Idle |
| `DeepBreath` | 21 | 24 × 48 | 9 | 1 | 62 ticks | Charge, Idle |
| `Nod` | 22 | 24 × 48 | 3 | 8 | 20 ticks | Idle |
| `Sit` | 23 | 24 × 48 | 3 | 1 | 24 ticks | Idle |
| `LookUp` | 24 | 24 × 48 | 3 | 1 | 18 ticks | Idle |
| `Sink` | 25 | 24 × 64 | 12 | 1 | 72 ticks | Idle |
| `Trip` | 26 | 40 × 56 | 5 | 8 | 22 ticks | Hurt |
| `Laying` | 27 | 24 × 40 | 1 | 8 | 12 ticks | Sleep |
| `LeapForth` | 28 | 24 × 112 | 6 | 1 | 14 ticks | Hop |
| `Head` | 29 | 24 × 48 | 1 | 8 | 4 ticks | Charge |
...
| `Faint` | 33 | 48 × 48 | 4 | 8 | 34 ticks | Hurt |

Animations d'origine conservées telles quelles : `Walk`, `Attack`, `Strike`, `Shoot (copie de Charge)`, `Punch`, `Sleep`, `Hurt`, `Idle`, `Swing`, `Double`, `Hop`, `Charge`, `Rotate`.
