# Politoed #0186 (Tarpaud) — animations de scène ajoutées

![Aperçu](apercu.png)

Le sprite officiel de Politoed sur [PMDCollab](https://sprites.pmdcollab.org/#/0186?form=0) a le set de donjon, mais
...
Chaque image part d'une **case officielle de Politoed lui-même** (Idle, Hurt, Hop, Charge, Rotate,
Sleep…). La palette des nouvelles feuilles est incluse dans celle du sprite d'origine
(15 couleurs) — le vérificateur le refuse sinon.
...
`-Offsets.png` marque `head`, `lhand` et `rhand` sur chaque case. Pour Politoed, les repères
...
donc calculées sur la hauteur réelle de la silhouette au repos de **Politoed** (24 px) :
...
| `politoed_scenes.aseprite` | Aseprite animé : un calque par direction, les 22 animations bout à bout, une étiquette chacune. |
...
| `Tumble` | 16 | 24 × 56 | 8 | 1 | 24 ticks | Rotate |
| `Pose` | 17 | 32 × 56 | 3 | 8 | 22 ticks | Charge, Idle |
| `Pull` | 18 | 32 × 56 | 7 | 1 | 76 ticks | Charge |
| `Pain` | 19 | 40 × 64 | 12 | 8 | 24 ticks | Hurt |
| `Float` | 20 | 32 × 64 | 4 | 8 | 50 ticks | Idle |
| `DeepBreath` | 21 | 32 × 56 | 9 | 1 | 62 ticks | Charge, Idle |
...
| `Trip` | 26 | 40 × 64 | 5 | 8 | 22 ticks | Hurt |
| `Laying` | 27 | 24 × 40 | 1 | 8 | 12 ticks | Sleep |
| `LeapForth` | 28 | 32 × 128 | 6 | 1 | 14 ticks | Hop |
| `Head` | 29 | 24 × 64 | 1 | 8 | 4 ticks | Charge |
| `Cringe` | 30 | 32 × 64 | 2 | 1 | 10 ticks | Hurt |
| `LostBalance` | 31 | 40 × 64 | 2 | 1 | 16 ticks | Hurt |
| `TumbleBack` | 32 | 24 × 64 | 10 | 1 | 30 ticks | Rotate |
| `HitGround` | 34 | 32 × 56 | 8 | 1 | 34 ticks | Hurt |
| `Faint` | 33 | 48 × 56 | 4 | 8 | 34 ticks | Hurt |

Animations d'origine conservées telles quelles : `Walk`, `Attack`, `Strike (copie de Attack)`, `Shoot`, `RearUp`, `Sleep`, `Hurt`, `Idle`, `Swing`, `Double`, `Hop`, `Charge`, `Rotate`.
