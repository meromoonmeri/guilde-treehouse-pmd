# Slurpuff #0685 (Aromatisse) — animations de scène ajoutées

![Aperçu](apercu.png)

Le sprite officiel de Slurpuff sur [PMDCollab](https://sprites.pmdcollab.org/#/0685?form=0) a le set de donjon, mais
...
Chaque image part d'une **case officielle de Slurpuff lui-même** (Idle, Hurt, Hop, Charge, Rotate,
Sleep…). La palette des nouvelles feuilles est incluse dans celle du sprite d'origine
(12 couleurs) — le vérificateur le refuse sinon.
...
`-Offsets.png` marque `head`, `lhand` et `rhand` sur chaque case. Pour Slurpuff, les repères
...
donc calculées sur la hauteur réelle de la silhouette au repos de **Slurpuff** (23 px) :

| Geste | Amplitude |
| --- | --- |
| plongée du repas | 3 px |
| respiration, hochement | 2 px |
| affaissement assis | 5 px |
...
| `slurpuff_scenes.aseprite` | Aseprite animé : un calque par direction, les 22 animations bout à bout, une étiquette chacune. |
...
| --- | --- | --- | --- | --- | --- | --- |
| `EventSleep` | 13 | 32 × 32 | 2 | 8 | 65 ticks | Sleep |
| `Wake` | 14 | 32 × 48 | 5 | 8 | 42 ticks | Idle, Sleep |
| `Eat` | 15 | 24 × 48 | 4 | 1 | 28 ticks | Idle |
| `Tumble` | 16 | 24 × 48 | 8 | 1 | 24 ticks | Rotate |
| `Pose` | 17 | 32 × 48 | 3 | 8 | 22 ticks | Charge, Idle |
| `Pull` | 18 | 32 × 48 | 7 | 1 | 76 ticks | Charge |
| `Pain` | 19 | 48 × 64 | 12 | 8 | 24 ticks | Hurt |
| `Float` | 20 | 32 × 56 | 4 | 8 | 50 ticks | Idle |
| `DeepBreath` | 21 | 32 × 48 | 9 | 1 | 62 ticks | Charge, Idle |
| `Nod` | 22 | 32 × 48 | 3 | 8 | 20 ticks | Idle |
| `Sit` | 23 | 24 × 48 | 3 | 1 | 24 ticks | Idle |
| `LookUp` | 24 | 24 × 48 | 3 | 1 | 18 ticks | Idle |
| `Sink` | 25 | 24 × 64 | 12 | 1 | 72 ticks | Idle |
| `Trip` | 26 | 48 × 64 | 5 | 8 | 22 ticks | Hurt |
| `Laying` | 27 | 32 × 32 | 1 | 8 | 12 ticks | Sleep |
| `LeapForth` | 28 | 24 × 112 | 6 | 1 | 14 ticks | Hop |
| `Head` | 29 | 32 × 48 | 1 | 8 | 4 ticks | Charge |
| `Cringe` | 30 | 32 × 64 | 2 | 1 | 10 ticks | Hurt |
| `LostBalance` | 31 | 40 × 56 | 2 | 1 | 16 ticks | Hurt |
| `TumbleBack` | 32 | 24 × 48 | 10 | 1 | 30 ticks | Rotate |
| `HitGround` | 34 | 32 × 56 | 8 | 1 | 34 ticks | Hurt |
| `Faint` | 33 | 56 × 64 | 4 | 8 | 34 ticks | Hurt |

Animations d'origine conservées telles quelles : `Walk`, `Attack`, `Shoot`, `Twirl (copie de Rotate)`, `Sleep`, `Hurt`, `Idle`, `Swing`, `Double`, `Hop`, `Charge`, `Rotate`.
