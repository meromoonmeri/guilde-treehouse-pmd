# Ambipom #0424 (Capidextre) — portraits d'émotions

![Aperçu](apercu.png)

Le dépôt [PMDCollab](https://sprites.pmdcollab.org/#/0424?form=0) ne publie que **3** portrait(s) pour ce Pokémon
(Happy, Normal, Surprised). Ce dossier complète la planche : **16 émotions** au
...
Particularité de ce portrait : face franche, deux grands yeux ronds.
