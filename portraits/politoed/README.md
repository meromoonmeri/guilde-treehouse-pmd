# Politoed #0186 (Tarpaud) — portraits d'émotions

![Aperçu](apercu.png)

Le dépôt [PMDCollab](https://sprites.pmdcollab.org/#/0186?form=0) ne publie que **4** portrait(s) pour ce Pokémon
(Inspired, Normal, Shouting, Surprised). Ce dossier complète la planche : **16 émotions** au
...
Particularité de ce portrait : portrait cadré serré : un seul œil visible, très grand ; le second est hors champ.
...
| --- | --- | --- | --- |
| `Normal` | 12 | officiel PMDCollab | — |
| `Happy` | 11 | yeux : arch | — |
| `Pain` | 12 | yeux : squeeze | goutte de sueur |
| `Angry` | 12 | yeux : slant | marque de colère |
| `Worried` | 11 | yeux : lid | — |
| `Sad` | 11 | yeux : lid | — |
| `Crying` | 12 | yeux : squeeze | larmes |
| `Shouting` | 14 | officiel PMDCollab | — |
| `Teary-Eyed` | 12 | yeux : wet | larmes |
| `Determined` | 11 | yeux : slant | — |
| `Joyous` | 12 | yeux : arch | croix de joie sur le fond |
| `Inspired` | 14 | officiel PMDCollab | — |
| `Surprised` | 15 | officiel PMDCollab | — |
| `Dizzy` | 10 | yeux : spiral | — |
| `Sigh` | 12 | yeux : line | soupir : goutte |
| `Stunned` | 12 | yeux : blank | hébétude : goutte |
