...
import zipfile
R=Path(__file__).resolve().parents[2];O=R/'renders/antre_raccords_v5';dest=O/'antre_raccords_v5.zip'
files=['apercu_antre_raccords_v5.html','source/layouts_magenta_v1/palette.py','source/amp_plains_fleurie_v1/inspect_references.py','source/eau_metano/natifs/Metano_Town_Animation_Tileset.tile','source/antre_harmonie_v3/references/altere_pond.rsground','renders/antre_harmonie_v3/manifest.json']
