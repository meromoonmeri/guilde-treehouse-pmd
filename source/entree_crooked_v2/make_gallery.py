"""Galerie autonome v2 : calques generes, jour/nuit (fleurs statiques)."""
...
def main():
    ...
    html = """<!doctype html><html lang="fr"><meta charset="utf-8">""" \
        """<title>Entree grotte Crooked/Halcyon/Sky Peak v2</title><style>""" \
        ...
        """<p>Les 8 calques <b>generes</b> (maquette = composite v1, refs canoniques """ \
        """Crooked/Halcyon/Sky Peak) et recales 1:1 (translations seules, snap 8). """ \
        """Fleurs statiques en v2 (pack v1 natif anime 4x200ms conserve). Nuit Abyss exacte.</p>""" \
        ...
        """lb.append(c,document.createTextNode(l.id+' (gen)'));""" \
        ...
        """draw()</script></html>"""
    (R / 'apercu_entree_crooked_v2.html').write_text(html)
