...
- Galerie : `apercu_foret_sinister_brume_v1.html` à la racine du dépôt.
...
## Reproduction
```
.venv/bin/python source/foret_sinister_brume_v1/build.py
.venv/bin/python source/foret_sinister_brume_v1/animate.py
.venv/bin/python source/foret_sinister_brume_v1/package.py
.venv/bin/python source/foret_sinister_brume_v1/test_v1.py
```
"""
...
<img src="renders/foret_sinister_brume_v1/preview_scene.webp" width="424" alt="preview anime">
...
<div class="row"><img src="renders/foret_sinister_brume_v1/SinisterGenV1_composite.png" style="max-width:424px"></div></div>
<div class="panel"><b>Bruts &amp; contrôles</b><div class="row">
<img src="renders/foret_sinister_brume_v1/bruts/foret_sinister_complete.png" width="300">
<img src="renders/foret_sinister_brume_v1/review/planche_masques.png" width="300">
<img src="renders/foret_sinister_brume_v1/review/sol_reconstitue.png" width="300">
...
ORA éditable + ZIP dans renders/foret_sinister_brume_v1*. Reproduction : voir README du lot.</small></div>
</div>
<script>
...
const ov=document.createElement('img');ov.src='renders/foret_sinister_brume_v1/anim/overlay_00.png';
...
ov.style.display='block';f=(f+1)%%48;ov.src='renders/foret_sinister_brume_v1/anim/overlay_'+String(f).padStart(2,'0')+'.png';},100);
</script></body></html>
""" % (items, "\n".join(
    '<img class="layer" data-layer="%s" src="renders/foret_sinister_brume_v1/calques/SinisterGenV1_%s.png">' % (nm, nm) for nm in ORDER), counts)
open(os.path.join(ROOT, "apercu_foret_sinister_brume_v1.html"), "w").write(html)
print("gallery ok")

# ---------- ZIP ----------
zp = os.path.join(ROOT, "renders", "foret_sinister_brume_v1_pack.zip")
if os.path.exists(zp):
    os.remove(zp)
z = zipfile.ZipFile(zp, "w", zipfile.ZIP_DEFLATED)
base = os.path.join(ROOT, "renders", "foret_sinister_brume_v1")
...
z.write(os.path.join(ROOT, "apercu_foret_sinister_brume_v1.html"), "apercu_foret_sinister_brume_v1.html")
z.close()
