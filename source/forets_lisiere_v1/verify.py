...
O = R / 'renders/forets_lisiere_v1'
sys.path.insert(0, str(R / 'source/cote_v4_abyss'))
from night import night  # noqa: E402
W, H = 928, 1152
ORDER = json.loads((O / 'A_clairiere_grotte_nord' / 'manifest.json').read_text())['layers_order_bottom_to_top']
...
def main():
    ...
    for mid in maps:
        ...
        r['mc_jour_exists'] = (R / 'exports/forets_lisiere_v1' / mid / 'multicalques' / f'{mid}_jour.aseprite').exists()
