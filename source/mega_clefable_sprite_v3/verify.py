...
R=Path(__file__).resolve().parents[2];O=R/'renders/mega_clefable_sprite_v3';OUT=O/'sprite/0036/0001';ok=[]
...
z=zipfile.ZipFile(O/'0036_0001_mega_clefable_v3_spritecollab.zip');chk('zip complete',set(z.namelist())=={p.name for p in OUT.iterdir()})
