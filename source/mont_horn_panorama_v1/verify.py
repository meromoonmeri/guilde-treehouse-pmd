...
R=Path(__file__).resolve().parents[2];O=R/'renders/mont_horn_panorama_v1';P=O/'mont_horn';S=O/'sprites';m=json.loads((O/'manifest.json').read_text());W,H=m['size']
...
static={n:im(P/f'horn_{n}.png') for n in m['static_layers']};order=['01_panorama_montagnes','02_nuages_lointains','03_falaises_gauches','04_falaises_droites','05_chemin_pierre_grise','06_entree_nord_et_marches','07_nuages_overlay']
