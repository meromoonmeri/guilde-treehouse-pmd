...
ROOT = HERE.parents[1]
REF = ROOT / "5394.png"
OUT = ROOT / "renders" / "thunder_meadow_v4_sommet"
PFX = "THUNDERMEADOW_V4_"
...
yy, xx = np.mgrid[:H, :W]
yy, xx = (yy // 2) * 2, (xx // 2) * 2  # pixels 2x2 : spirale lisible, style pixel art
...
cmp_.save(OUT / "apercu" / "reference_vs_v4.png")
...
with zipfile.ZipFile(OUT.parent / "thunder_meadow_v4_sommet_pack.zip", "w", zipfile.ZIP_DEFLATED) as z:
    for p in sorted(OUT.rglob("*")):
        if p.is_file(): z.write(p, p.relative_to(OUT.parent))
    z.write(__file__, "thunder_meadow_v4_sommet/source/build.py")
