...
base.save(LAY/'00_fond_committe_image.png');fg.save(LAY/'01_continents_iles_lieux.png');full=base.copy();full.alpha_composite(fg);full.save(OUT/'WorldMap_9_Continents_UserBackground.png')
