...
ROOT=Path(__file__).resolve().parents[2]; OUT=ROOT/'renders/world_map_texture_strict_v5'; LAY=OUT/'layers'; RAW=ROOT/'source/world_map_texture_strict_v5/raws/map_layout_strict_texture.png'
if OUT.exists(): shutil.rmtree(OUT)
(LAY/'cloud_animation').mkdir(parents=True)
mapim=Image.open(RAW).convert('RGBA'); mapim.save(LAY/'00_map_texture_stricte.png'); mapim.save(OUT/'WorldMap_Texture_Strict_Layout.png')
