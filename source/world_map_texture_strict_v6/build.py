...
ROOT=Path(__file__).resolve().parents[2]; OUT=ROOT/'renders/world_map_texture_strict_v6'; LAY=OUT/'layers'; RAW=ROOT/'source/world_map_texture_strict_v6/raws/map_layout_more_mountains_forests_archipelago.png'
if OUT.exists(): shutil.rmtree(OUT)
(LAY/'cloud_animation').mkdir(parents=True)
mapim=Image.open(RAW).convert('RGBA'); mapim.save(LAY/'00_map_texture_stricte.png'); mapim.save(OUT/'WorldMap_Texture_Strict_Layout_v6.png')
