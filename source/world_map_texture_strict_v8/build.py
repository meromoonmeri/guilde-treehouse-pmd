...
ROOT=Path(__file__).resolve().parents[2]; OUT=ROOT/'renders/world_map_texture_strict_v8'; LAY=OUT/'layers'; RAW=ROOT/'source/world_map_texture_strict_v8/raws/layout_attachment_arrangement.png'
if OUT.exists(): shutil.rmtree(OUT)
(LAY/'cloud_animation').mkdir(parents=True)
mapim=Image.open(RAW).convert('RGBA'); mapim.save(LAY/'00_map_texture_stricte.png'); mapim.save(OUT/'WorldMap_Texture_Strict_Layout_v8.png')
