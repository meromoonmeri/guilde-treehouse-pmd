...
ROOT=Path(__file__).resolve().parents[2];OUT=ROOT/'renders/world_map_userfond_v1';size=Image.open(ROOT/'source/user_committed_map_background.png').size
assert Image.open(OUT/'WorldMap_UserFond_9Continents.png').size==size
