...
OUT = ROOT / "renders" / "zone_d06p11_v11"; PFX = "D06P11_V11_"
...
with zipfile.ZipFile(OUT.parent / "zone_d06p11_v11_pack.zip", "w", zipfile.ZIP_DEFLATED) as z:
    for p in sorted(OUT.rglob("*")):
        if p.is_file(): z.write(p, p.relative_to(OUT.parent))
    z.write(__file__, "zone_d06p11_v11/source/build.py")
