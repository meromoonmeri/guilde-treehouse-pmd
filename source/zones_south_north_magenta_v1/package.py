#!/usr/bin/env python3
"""Rebuild, verify and package the single five-layer forest Ground."""
...
PROJECT = ROOT / "exports/forest_cave_magenta_v1_pmdo"
DEFAULT_ZIP = ROOT / "exports/forest_cave_magenta_v1_pmdo_pack.zip"
...
def main() -> None:
    ...
    print(f"Archive forêt magenta valide : {output} ({output.stat().st_size / 2**20:.2f} MiB)")
