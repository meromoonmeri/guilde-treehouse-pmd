...
`d6` est la version retenue : elle conserve `d4` trait pour trait et ne change
que l'encadrement de l'entrée, jusque-là dans un doré pâle qui jurait avec le
reste. Les montants et l'arc reprennent le bois miel des poteaux et du comptoir
du kiosque, veinures et contours compris.
...
python3 ../tileset_pmd/detourer_magenta.py \
    spindacafevFINAL.png ../variantes/d6_porte_bois_kiosque.png sortie.png
```

La version détourée de `d6` est déjà disponible :
